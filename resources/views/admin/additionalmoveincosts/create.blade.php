...
{!! Form::open(array('route' => config('quickadmin.route').'.additionalmoveincosts.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('memo', old('memo'), array('class'=>'form-control')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::text('dueon', old('dueon'), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('securitydeposit_id', 'securityId*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::select('securitydeposit_id', $securitydeposit, old('securitydeposit_id'), array('class'=>'form-control')) !!}
